...
class FeatureContext extends SilverStripeContext {
    ...
    /**
	 * @Given /^I fill in the input field "([^"]*)" with "([^"]*)"$/
	 */
    public function fillnTheFieldByLabel($labelText, $value) {
        $page = $this->getSession()->getPage();
        $label = $this->getSession()->getSelectorsHandler()->xpathLiteral($labelText);
        # go to parent: /..
        # any path: /*/
        $inputEl = $page->find('xpath', "//label[contains(.," . $label . ")]/../../*/input");
        $selectEl = $page->find('xpath', "//label[contains(.," . $label . ")]/../../*/select");
        $el = $inputEl ? $inputEl : $selectEl;
        assertNotNull($el);
